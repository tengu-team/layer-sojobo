...
if __name__ == '__main__':
    ...
    logger = logging.getLogger('remove_unit')
    hdlr = logging.FileHandler('{}/log/remove_unit.log'.format(settings.SOJOBO_API_DIR))
    ...
    loop.set_debug(True)
    loop.run_until_complete(remove_unit(sys.argv[1], sys.argv[2], sys.argv[3],
